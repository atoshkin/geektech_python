...
class TrickyBastard(Hero):
    def __init__(self, name, health, damage, super_ability=random.randint(0,3)):
        Hero.__init__(self, name, health, damage, 'UlTIMATE')
...
def start():
    ...
    chelek_pauk = Chelek_pauk('Chelek_pauk', 180, 5)
    heroes = [medic, magic, warrior, medic1, berserk, thor, golem, witcher, hacker, tricky_Bastard, chelek_pauk]
